 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert([
        {
          user_id: 'demo-user', // Temporary - we'll add real auth later
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          setFormData({ ...formData, profileType: type.value })
                        }
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Sarah's Sustainable Style"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-indigo-500 focus:outline-none"
                    placeholder="I help women build sustainable wardrobes..."
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    },
                    {
                      value: 'professional',
                      label: 'Professional',
                      desc: 'Polished and business-focused',
                    },
                    {
                      value: 'humorous',
                      label: 'Humorous & Playful',
                      desc: 'Witty, fun, and entertaining',
                    },
                    {
                      value: 'inspirational',
                      label: 'Inspirational',
                    ...
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        setFormData({ ...formData, brandVoice: voice.value })
                      }
                      ...
                      (platform) => (
                        <button
                          ...
                          className={`px-4 py-3 rounded-lg border-2 font-medium transition-all ${
                            formData.platforms.includes(platform.toLowerCase())
            ...
            {step === 3 && (
              <div className="space-y-6">
                ...
                <p className="text-gray-600 mb-4">
                  Select topics you commonly create content about
                </p>
            ...
            {step === 4 && (
              <div className="space-y-6">
                ...
                <p className="text-gray-600 mb-6">
                  Connect your accounts so our AI can learn from your existing posts and match your authentic voice.
                </p>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">
                            Import your recent posts and captions
                          </div>
                        </div>
                      </div>
                      <button
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">
                            Import your recent tweets
                          </div>
                        </div>
                      </div>
                      <button
                        type="button"
                        onClick={() => alert('Twitter connection coming soon!')}
                        className="px-6 py-2 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700"
                      >
                        Connect
                      </button>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">
                            Import your professional posts
                          </div>
                        </div>
                      </div>
                      <button
                        type="button"
                        onClick={() => alert('LinkedIn connection coming soon!')}
                        className="px-6 py-2 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700"
                      >
                        Connect
                      </button>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">
                            Import your video descriptions
                          </div>
                        </div>
                      </div>
                      <button
                        type="button"
                        onClick={() => alert('TikTok connection coming soon!')}
                        className="px-6 py-2 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700"
                      >
                        Connect
                      </button>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-blue-900 mb-1">
                        Don't have posts yet? No problem!
                      </div>
                      <div className="text-sm text-blue-800">
                        You can skip this step and start generating content right away.
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex justify-between mt-8">
              ...
              {step < 4 ? (
                <button
                  type="button"
                  onClick={() => setStep(step + 1)}
                  className="ml-auto px-6 py-3 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700"
                >
                  Continue
                </button>
              ) : (
                <button
                  type="submit"
                  className="ml-auto px-8 py-3 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700"
                >
